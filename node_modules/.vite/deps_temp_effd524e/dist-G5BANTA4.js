...
var require_utils = __commonJS({
  "node_modules/@coinbase/wallet-sdk/node_modules/@noble/hashes/utils.js"(exports) {
    ...
    function wrapConstructor2(hashCons) {
      const hashC = (msg) => hashCons().update(toBytes14(msg)).digest();
      const tmp = hashCons();
    ...
    function wrapConstructorWithOpts(hashCons) {
      const hashC = (msg, opts) => hashCons(opts).update(toBytes14(msg)).digest();
      const tmp = hashCons({});
      hashC.outputLen = tmp.outputLen;
      hashC.blockLen = tmp.blockLen;
...
var HashMD = class extends Hash {
  ...
  digestInto(out) {
    ...
    aoutput(out, this);
    this.finished = true;
    const { buffer: buffer2, view, blockLen, isLE: isLE6 } = this;
    let { pos } = this;
    buffer2[pos++] = 128;
...
function ecdsa(Point2, hash8, ecdsaOpts = {}) {
  ahash(hash8);
  ...
  const hmac4 = ecdsaOpts.hmac || ((key, ...msgs) => hmac(hash8, key, concatBytes(...msgs)));
  ...
  function sign7(message, secretKey, opts = {}) {
    ...
    const drbg = createHmacDrbg(hash8.outputLen, Fn.BYTES, hmac4);
...
function weierstrass(c) {
  ...
  const Point2 = weierstrassN(CURVE, curveOpts);
  const signs = ecdsa(Point2, hash8, ecdsaOpts);
...
var ripemd1604 = createHasher4(() => new RIPEMD1602());
...
function bytesToNumber(bytes2) {
  abytes3(bytes2);
  const h2 = bytes2.length === 0 ? "0" : bytesToHex2(bytes2);
  return BigInt("0x" + h2);
}
...
var hash160 = (data) => ripemd1604(sha2565(data));
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/pbkdf2.js
function pbkdf2Init(hash8, _password, _salt, _opts) {
  ...
  const PRF = hmac3.create(hash8, password);
...
// node_modules/@coinbase/wallet-sdk/node_modules/@scure/bip39/esm/index.js
...
var calcChecksum = (entropy) => {
  ...
  return new Uint8Array([sha2566(entropy)[0] >> bitsLeft << bitsLeft]);
};
...
function mnemonicToSeedSync(mnemonic, passphrase = "") {
  return pbkdf2(sha5124, normalize2(mnemonic).nfkd, psalt(passphrase), { c: 2048, dkLen: 64 });
}
...
*/
//# sourceMappingURL=dist-G5BANTA4.js.map
