...
var ICONS = {
  add: async () => (await import("./add-WU7JBR7L.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-6672YO2Q.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-2JRT53ML.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-6IJEKU37.js")).appStoreSvg,
  apple: async () => (await import("./apple-UPE6HPDT.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-BG6TO4IO.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-X4CMLMTJ.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-FMNDXTW7.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-BWNPUQEP.js")).arrowTopSvg,
  bank: async () => (await import("./bank-PIXUTBTW.js")).bankSvg,
  browser: async () => (await import("./browser-CAQLXVMK.js")).browserSvg,
  card: async () => (await import("./card-VL3QCEFD.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-TVTFS4HS.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-4BLWN53Y.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-4P4MCS74.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-4U74RFCF.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-JLHCQM67.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-HUBXQMNT.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-MJAKNSEE.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-X3QCN325.js")).clockSvg,
  close: async () => (await import("./close-772FZQOH.js")).closeSvg,
  compass: async () => (await import("./compass-DV3A7ZI7.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-MRENRCII.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-HLYWCE7O.js")).copySvg,
  cursor: async () => (await import("./cursor-WWETNTGU.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-UIZM6PBD.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-AQJRA4RE.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-3HJUQ4GF.js")).disconnectSvg,
  discord: async () => (await import("./discord-V4C5TFFE.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-5TI4OSEM.js")).etherscanSvg,
  extension: async () => (await import("./extension-NY2CUW4P.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-X23ICZZU.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-G36UVK5N.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-2LFSSGBB.js")).farcasterSvg,
  filters: async () => (await import("./filters-PNWXZW3K.js")).filtersSvg,
  github: async () => (await import("./github-3MJJZ4EA.js")).githubSvg,
  google: async () => (await import("./google-FLN6NMME.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-HQ7P3Y6E.js")).helpCircleSvg,
  image: async () => (await import("./image-YJCRLEGO.js")).imageSvg,
  id: async () => (await import("./id-QHSDPA2I.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-M32N5EMM.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-TZJW22RE.js")).lightbulbSvg,
  mail: async () => (await import("./mail-IOAMFCIG.js")).mailSvg,
  mobile: async () => (await import("./mobile-JM5NPKWG.js")).mobileSvg,
  more: async () => (await import("./more-QP7S2E3Q.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-RAFTEZYT.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-V5PPAMQU.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-FZFEEYZS.js")).offSvg,
  playStore: async () => (await import("./play-store-37IVO7WC.js")).playStoreSvg,
  plus: async () => (await import("./plus-XW5YSYWG.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-EGVLXRQX.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-N27KR5RO.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-X3DCS7Y2.js")).refreshSvg,
  search: async () => (await import("./search-RPW2DQZI.js")).searchSvg,
  send: async () => (await import("./send-OPHBV2QC.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-QFV5CYMF.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-YT3P2JW2.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-TUFOZMHS.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-22D6INLM.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-D7FHIL5O.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-FPPVZDAG.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-WWTAC623.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-SBVTCJHL.js")).twitchSvg,
  twitter: async () => (await import("./x-53A6JYIM.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-KRMPWQAH.js")).twitterIconSvg,
  verify: async () => (await import("./verify-3XWTOH4P.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-RGI52LRS.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-ZOX7AGU3.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-NK4FMFZJ.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-NK4FMFZJ.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-NK4FMFZJ.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-SVFSY6TE.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-DKJIRBQL.js")).warningCircleSvg,
  x: async () => (await import("./x-53A6JYIM.js")).xSvg,
  info: async () => (await import("./info-MQITUXVJ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-MWQETQFX.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-IRXGNTHH.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-W6ZBSZZE.js.map
