...
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-UNVHDXH7.js";
import {
  useQuery
} from "./chunk-5KAEK33V.js";
import {
  require_react_dom
} from "./chunk-LK5U2UVZ.js";
import "./chunk-GJQBC4OC.js";
import {
  require_jsx_runtime
...
import {
  ...
  safe,
  walletConnect
} from "./chunk-X4RCKVWK.js";
import {
  createConfig,
  createConnector,
  injected
} from "./chunk-T3MHDBJU.js";
...
var _Field2 = class {
  constructor(Fp4, opts = {}) {
    ...
    this.Fp_div2 = Fp4.div(Fp4.ONE, _2n2);
...
function pointG2FromBytes(bytes) {
  ...
  const slc = (b, from25, to3) => bytesToNumberBE(b.slice(from25, to3));
...
function edwards(params, extraOpts = {}) {
  ...
  const MASK = _2n4 << BigInt(Fn2.BYTES * 8) - _1n4;
...
function eddsa(Point2, cHash, eddsaOpts = {}) {
  ...
  const { BASE, Fp: Fp4, Fn: Fn2 } = Point2;
  ...
  function modN_LE(hash8) {
    return Fn2.create(bytesToNumberLE(hash8));
  }
...
function twistedEdwards(c) {
  const { CURVE, curveOpts, hash: hash8, eddsaOpts } = _eddsa_legacy_opts_to_new(c);
  const Point2 = edwards(CURVE, curveOpts);
  const EDDSA = eddsa(Point2, hash8, eddsaOpts);
...
function montgomery(curveDef) {
  ...
  const { P, type: type6, adjustScalarBytes: adjustScalarBytes2, powPminus2, randomBytes: rand } = CURVE;
...
var ELL2_C1 = (() => (ed25519_CURVE_p + _3n4) / _8n2)();
...
var cfb = wrapCipher({ blockSize: 16, nonceLength: 16 }, function aescfb(key, iv) {
  function processCfb(src7, isEncrypt, dst) {
    ...
    if (!isAligned32(_iv))
      toClean.push(_iv = copyBytes2(_iv));
    if (!isAligned32(src7))
      toClean.push(src7 = copyBytes2(src7));
    const src32 = u322(src7);
    const dst32 = u322(dst);
